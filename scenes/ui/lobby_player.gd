...
func _set_player_role(value: Statics.Role) -> void:
	...
	match value:
		Statics.Role.BLACKJACK:
			player_role.text = "Blackjack"
		Statics.Role.ROULETTE:
			player_role.text = "Roulette"
		Statics.Role.SLOT_MACHINE:
			player_role.text = "Slot Machine"
		Statics.Role.DUDO:
			player_role.text = "Dudo"
